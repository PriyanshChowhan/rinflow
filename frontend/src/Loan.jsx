...
//         const ml = await fetch(`http://localhost:5000/predict`, {
//           method: "POST",
//           headers: {
...
//   //   try {
//   //     const response = await axios.patch(`http://localhost:8000/api/v1/loanOfficer/${id}`, {
//   //       loan_status: status,
//   //     });
//   //     setLoan((prev) => ({ ...prev, loan_status: status }));
//   //     alert(`Loan ${status.toLowerCase()} successfully!`);
//   //   } catch (err) {
//   //     alert(err.response?.data?.message || `Failed to ${status.toLowerCase()} loan`);
//   //   }
//   // }
...
//   useEffect(() => {
//     async function fetchLoanDetails() {
//       if (!id) return; // Add a guard clause
...
//                           : 'text-red-600'
//                       }`}>
//                         Predicted Outcome: {mlResponse.prediction === 1 ? 'Approval Recommended' : 'Rejection Recommended'}
//                       </div>
//                     </div>
