...
async function sendEnvelope({ loanId, recipientEmail, recipientName, docusignConfig }) {
...
async function sendSignReq({ loanId, recipientEmail, recipientName, docusignConfig }) {
  try {
